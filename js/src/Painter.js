...
Painter.prototype.drawFallingPiece = function (fallingPiece, fallingPoint, ghostPoint, landed) {
	var blocks;
	if (fallingPiece !== this._state.fallingPiece || landed !== this._state.landed) {
		blocks = landed ? this._blocks.light : this._blocks.normal;
		this._drawPiece(this._contexts.fallingPiece, fallingPiece, blocks);
		this._drawPiece(this._contexts.ghostPiece, fallingPiece, this._blocks.normal);
	}
...
Painter.prototype.drawPreview = function (preview) {
	...
	for (i = 0; i < n; ++i)
		this._drawPiece(this._previewContexts[i], preview[i], this._blocks.normal, null, true);
};
...
Painter.prototype.setFigures = function (figures, ignoreCache) {
	...
	Painter._setFigure(this._labels.$lines, figures.lines, this._state.lines, ignoreCache);
	Painter._setFigure(this._labels.$score, figures.score, this._state.score, ignoreCache);
	for (name in figures)
...
Painter.prototype._setState = function (fallingPiece, fallingPoint, ghostPoint, landed) {
